...
:!email: {author-email}
:revnumber: v1.20.0
:revdate: 2019-11-30T16:31:31+0900
:revmark: Add a caution block when using boolean for attribute
:doctype: article
...
:issues-url: {github-url}/hitsuji-no-shippo/gatsby-transformer-asciidoc/issues
...
*Please read
link:{github-url}/hitsuji-no-shippo/self-referenced-object/tree/60f18190c552116aa5a4e30879b7a7d4832b9362[
...
----
<1> Whether to run refer processing. (Default is `true`)
<2> Whether to convert reference from directory to key
...
----
<1> Relative Directory (`node.relativeDirectory`) + Name (`node.name`)
+
--
[EXAMPLE]
====
...
|<gatsby-project-root>/content/blog/about.adoc       | /about
|<gatsby-project-root>/content/blog/post/gatsby.adoc | /about/gatsby
|========================================================================
====
--
