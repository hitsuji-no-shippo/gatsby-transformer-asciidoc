...
:!email: {author-email}
:revnumber: v1.10.0
:revdate: 2019-09-03T16:22:59+0900
:revmark: Change if no `skip-front-matter` is set the default value is `true` \
          to asciidoctor attribute `skip-front-matter` is always `true`
:doctype: article
