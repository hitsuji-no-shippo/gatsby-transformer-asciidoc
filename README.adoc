...
:!email: {author-email}
:revnumber: v1.0.0
:revdate: 2019-08-12T22:56:08+0900
:revmark: Convert markdown to asciidoc
:doctype: article
:title-separtor: :
:!showtitle:
:!sectnums:
...
:!listing-caption:
// Page Attributes
:page-create-date: 2019-08-12T22:56:08+0900
// Variables
...
`pageAttributes` so it can be used with GraphQL.
