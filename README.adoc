...
:!email: {author-email}
:revnumber: v1.23.0
:revdate: 2019-12-24T17:19:10+0900
:revmark: Add fileAbsolutePath field
:doctype: article
...
Used path value is xref:relative-full-path-field[relativeFullPath field] value.
*Please read
...
----
<1> `''` is `:unpublish:`, `'true'` is `:unpublish: true`.
